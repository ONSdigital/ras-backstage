...
url_get_messages = f"{app.config['RAS_SECURE_MESSAGING_SERVICE']}messages?label=INBOX&limit=1000"
...
url_send_message = f"{app.config['RAS_SECURE_MESSAGING_SERVICE']}message/send"
