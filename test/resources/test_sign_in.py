...
class TestSignIn(unittest.TestCase):
    ...
    def setUp(self):
        self.url_get_token = '{}{}'.format(app.config['RAS_OAUTH_SERVICE'], 'api/v1/tokens/')
    ...
    def test_sign_in_success(self, mock_request):
        mock_request.post(self.url_get_token, status_code=201, json=self.oauth2_response)

        response = self.app.post('/backstage-api/v1/sign-in', headers=self.headers,
